...
class BusinessInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const BusinessInstructionPage({
    super.key,
  ...
  @override
  State<BusinessInstructionPage> createState() =>
      _BusinessInstructionPageState();
}

class _BusinessInstructionPageState extends State<BusinessInstructionPage> {
