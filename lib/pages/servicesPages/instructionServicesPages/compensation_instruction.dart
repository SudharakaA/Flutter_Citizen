...
class CompensationInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const CompensationInstructionPage({
    super.key,
  ...
  @override
  State<CompensationInstructionPage> createState() =>
      _CompensationInstructionPageState();
}

class _CompensationInstructionPageState
    extends State<CompensationInstructionPage> {
