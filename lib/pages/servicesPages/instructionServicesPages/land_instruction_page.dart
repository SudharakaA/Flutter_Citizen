...
class LandInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const LandInstructionPage({
    super.key,
  ...
  @override
  State<LandInstructionPage> createState() => _LandInstructionPageState();
}

class _LandInstructionPageState extends State<LandInstructionPage> {
