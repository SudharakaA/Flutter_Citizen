...
class GrievanceInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const GrievanceInstructionPage({
    super.key,
  ...
  @override
  State<GrievanceInstructionPage> createState() =>
      _GrievanceInstructionPageState();
}

class _GrievanceInstructionPageState extends State<GrievanceInstructionPage> {
