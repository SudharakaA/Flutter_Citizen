...
class CertificateInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const CertificateInstructionPage({
    super.key,
  ...
  @override
  State<CertificateInstructionPage> createState() =>
      _CertificateInstructionPageState();
}

class _CertificateInstructionPageState
    extends State<CertificateInstructionPage> {
