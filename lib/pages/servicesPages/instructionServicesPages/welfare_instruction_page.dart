...
class WelfareInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const WelfareInstructionPage({
    super.key,
  ...
  @override
  State<WelfareInstructionPage> createState() => _WelfareInstructionPageState();
}

class _WelfareInstructionPageState extends State<WelfareInstructionPage> {
