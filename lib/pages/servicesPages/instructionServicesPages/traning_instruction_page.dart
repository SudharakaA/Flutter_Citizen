...
class TraningInstructionPage extends StatefulWidget {
  final String requestTypeId;
  final String accessToken;
  final String citizenCode;
  final String title;

  const TraningInstructionPage({
    super.key,
  ...
  @override
  State<TraningInstructionPage> createState() => _TraningInstructionPageState();
}

class _TraningInstructionPageState extends State<TraningInstructionPage> {
