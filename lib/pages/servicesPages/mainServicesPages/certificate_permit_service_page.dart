...
import '../instructionServicesPages/certificate_instruction_page.dart';
import 'package:http/http.dart' as http;
import 'package:easy_localization/easy_localization.dart';

class CertificatePermitServicePage extends StatefulWidget {
  final String accessToken;
  final String citizenCode;

  const CertificatePermitServicePage({
    super.key,
  ...
  @override
  State<CertificatePermitServicePage> createState() =>
      _CertificatePermitServicePageState();
}

class _CertificatePermitServicePageState
    extends State<CertificatePermitServicePage> {
  late Future<List<Map<String, dynamic>>> _certificatePermitFuture;

  @override
  void initState() {
    super.initState();
    _certificatePermitFuture = fetchCertificatePermitServices();
  }

  Future<List<Map<String, dynamic>>> fetchCertificatePermitServices() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('failed_certificate_services'.tr());
    }
  }
  ...
  void navigateToInstructions(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CertificateInstructionPage(
        ...
        child: Column(
          children: [
            Text(
              ...
              "certificate_and_permit_issuance".tr(),
            ...
            Expanded(
                child: FutureBuilder<List<Map<String, dynamic>>>(
                    future: _certificatePermitFuture,
