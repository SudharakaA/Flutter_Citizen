...
import '../instructionServicesPages/nic_instruction_page.dart';
import 'package:http/http.dart' as http;
import 'package:easy_localization/easy_localization.dart';

class NicServicePage extends StatefulWidget {
  final String accessToken;
  final String citizenCode;

  const NicServicePage({
    super.key,
  ...
  @override
  State<NicServicePage> createState() => _NicServicePageState();
}

class _NicServicePageState extends State<NicServicePage> {
  late Future<List<Map<String, dynamic>>> _nicServiceFuture;

  @override
  void initState() {
    super.initState();
    _nicServiceFuture = fetchNicServices();
  }

  Future<List<Map<String, dynamic>>> fetchNicServices() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('failed_nic_services'.tr());
    }
  }
  ...
  void navigateToInstructions(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => NICInstructionPage(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text(
              "national_identity_card_services".tr(),
