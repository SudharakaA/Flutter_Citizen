...
import '../instructionServicesPages/business_instruction_page.dart';
import 'package:http/http.dart' as http;
import 'package:easy_localization/easy_localization.dart';

class BusinessRegistrationServicePage extends StatefulWidget {
  final String accessToken;
  final String citizenCode;

  const BusinessRegistrationServicePage({
    super.key,
  ...
  @override
  State<BusinessRegistrationServicePage> createState() =>
      _BusinessRegistrationServicePageState();
}

class _BusinessRegistrationServicePageState
    extends State<BusinessRegistrationServicePage> {
  late Future<List<Map<String, dynamic>>> _businessServiceFuture;

  @override
  void initState() {
    super.initState();
    _businessServiceFuture = fetchBusinessServices();
  }

  Future<List<Map<String, dynamic>>> fetchBusinessServices() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('failed_business_registration_services'.tr());
    }
  }
  ...
  void navigateToInstructions(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BusinessInstructionPage(
        ...
        child: Column(
          children: [
            Text(
              ...
              "business_registration_services".tr(),
