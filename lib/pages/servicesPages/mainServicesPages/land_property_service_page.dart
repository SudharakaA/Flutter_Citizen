...
import '../instructionServicesPages/land_instruction_page.dart';
import 'package:http/http.dart' as http;
import 'package:easy_localization/easy_localization.dart';

class LandServicePage extends StatefulWidget {
  final String accessToken;
  final String citizenCode;

  const LandServicePage({
    super.key,
  ...
  @override
  State<LandServicePage> createState() => _LandServicePageState();
}

class _LandServicePageState extends State<LandServicePage> {
  late Future<List<Map<String, dynamic>>> _landServiceFuture;

  @override
  void initState() {
    super.initState();
    _landServiceFuture = fetchLandService();
  }

  Future<List<Map<String, dynamic>>> fetchLandService() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('failed_land_services'.tr());
    }
  }
  ...
  void navigateToInstructions(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => LandInstructionPage(
