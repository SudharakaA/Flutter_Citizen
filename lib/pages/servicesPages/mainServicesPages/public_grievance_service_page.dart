...
import '../instructionServicesPages/grievance_instruction_page.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;
import 'package:easy_localization/easy_localization.dart';

class PublicGrievanceServicePage extends StatefulWidget {
  final String accessToken;
  final String citizenCode;

  const PublicGrievanceServicePage(
      {super.key, required this.accessToken, required this.citizenCode});

  @override
  State<PublicGrievanceServicePage> createState() =>
      _PublicGrievanceServicePageState();
}

class _PublicGrievanceServicePageState
    extends State<PublicGrievanceServicePage> {
  late Future<List<Map<String, dynamic>>> _grievanceServiceFuture;

  @override
  void initState() {
    super.initState();
    _grievanceServiceFuture = fetchGrievanceServices();
  }

  Future<List<Map<String, dynamic>>> fetchGrievanceServices() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('failed_grievance_services'.tr());
    }
  }
  ...
  void navigateToInstructions(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => GrievanceInstructionPage(
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Text(
              "public_grievance_and_assistance".tr(),
            ...
            Expanded(
                child: FutureBuilder<List<Map<String, dynamic>>>(
                    future: _grievanceServiceFuture,
