...
import '../instructionServicesPages/compensation_instruction.dart';
import 'package:http/http.dart' as http;
import 'package:easy_localization/easy_localization.dart';

class CompensationServicePage extends StatefulWidget {
  final String accessToken;
  final String citizenCode;

  const CompensationServicePage({
    super.key,
  ...
  @override
  State<CompensationServicePage> createState() =>
      _CompensationServicePageState();
}

class _CompensationServicePageState extends State<CompensationServicePage> {
  late Future<List<Map<String, dynamic>>> _compensationServiceFuture;

  @override
  void initState() {
    super.initState();
    _compensationServiceFuture = fetchCompensationServices();
  }

  Future<List<Map<String, dynamic>>> fetchCompensationServices() async {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('failed_compensation_services'.tr());
    }
  }
  ...
  void navigateToInstructions(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => CompensationInstructionPage(
          ...
          children: [
            ...
            Expanded(
                child: FutureBuilder<List<Map<String, dynamic>>>(
                    future: _compensationServiceFuture,
