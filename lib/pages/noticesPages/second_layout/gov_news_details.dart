...
class GovNewsSupportDetailPage extends StatefulWidget {
  final String itemTitle;
  final String itemText;
  final String accessToken;
  final String citizenCode;

  const GovNewsSupportDetailPage({
    super.key,
  ...
  @override
  State<GovNewsSupportDetailPage> createState() =>
      _GovNewsSupportDetailPageState();
}

class _GovNewsSupportDetailPageState extends State<GovNewsSupportDetailPage> {
              ...
              child: FutureBuilder<Map<String, dynamic>?>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Center(
                      child: Text(
                        'error_loading_services'.tr(args: [snapshot.error.toString()]),
                        textAlign: TextAlign.center,
                      ),
                    );
                  }
