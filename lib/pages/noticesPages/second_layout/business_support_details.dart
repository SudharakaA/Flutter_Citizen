...
class BusinessSupportDetailPage extends StatefulWidget {
  final String itemTitle;
  final String itemText;
  final String accessToken;
  final String citizenCode;

  const BusinessSupportDetailPage({
    super.key,
  ...
  @override
  State<BusinessSupportDetailPage> createState() =>
      _BusinessSupportDetailPageState();
}

class _BusinessSupportDetailPageState extends State<BusinessSupportDetailPage> {
