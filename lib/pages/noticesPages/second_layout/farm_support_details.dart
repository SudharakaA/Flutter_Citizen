...
class AgricultureSupportDetailPage extends StatefulWidget {
  final String itemTitle;
  final String itemText;
  final String accessToken;
  final String citizenCode;

  const AgricultureSupportDetailPage({
    super.key,
  ...
  @override
  State<AgricultureSupportDetailPage> createState() =>
      _AgricultureSupportDetailPageState();
}

class _AgricultureSupportDetailPageState
    extends State<AgricultureSupportDetailPage> {
