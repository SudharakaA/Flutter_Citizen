...
class AddPrivilege extends StatefulWidget {
  const AddPrivilege({super.key});

  @override
  State<AddPrivilege> createState() => _AddStoreDataState();
}

class _AddStoreDataState extends State<AddPrivilege> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildDropdownField(
                      ...
                      validatorMsg: "Please select Privilege Category",
                      screenWidth: screenWidth,
                      screenHeight: screenHeight,
                    ),
                    buildDropdownField(
                      label: "Autharization Role",
                      value: _selectedrole,
                      items: _role,
