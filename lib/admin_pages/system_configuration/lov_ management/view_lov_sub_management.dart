...
import '../user_configuration/action_bar.dart';
import 'add_sub_lov.dart';


class ViewLovSubManagement extends StatefulWidget {
  const ViewLovSubManagement({super.key});

  @override
  State<ViewLovSubManagement> createState() => _ViewPrivilegeDetailsPage();
}

class _ViewPrivilegeDetailsPage extends State<ViewLovSubManagement> {
  ...
  final List<Map<String, dynamic>> _columnDefinitions = [
    ...
    {'key': 'sname', 'label': 'Subject Name', 'width': 150.0},
  ];
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              ActionBar(
                title: 'Citizen LOV Management Sub',
        ...
        menuItems: [
          ...
          HoverTapButton(
            ...
            onTap: () {
              showDialog(
                  context: context,
                  builder: (context) => const AddSubLov()
              );
            },
          ),
