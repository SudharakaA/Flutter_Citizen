...
import 'add_subject_config.dart';


class ViewSubjectManagent extends StatefulWidget {
  const ViewSubjectManagent({super.key});

  @override
  State<ViewSubjectManagent> createState() => _ViewPrivilegeDetailsPage();
}

class _ViewPrivilegeDetailsPage extends State<ViewSubjectManagent> {
        ...
        menuItems: [
          ...
          HoverTapButton(
            ...
            onTap: () {
              showDialog(
                  context: context,
                  builder: (context) => const AddSubjectConfig()
              );
            },
          ),
