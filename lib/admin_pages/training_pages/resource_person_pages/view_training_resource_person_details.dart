...
class ViewTrainingResourcePersonDetails extends StatefulWidget {
  const ViewTrainingResourcePersonDetails({super.key});

  @override
  State<ViewTrainingResourcePersonDetails> createState() => _ViewTrainingResourcePersonDetailsState();
}

class _ViewTrainingResourcePersonDetailsState extends State<ViewTrainingResourcePersonDetails> {
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                             Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TrainingResourcePersonPage(
