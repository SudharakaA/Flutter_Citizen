...
class AddNewResourcePerson extends StatefulWidget {
  const AddNewResourcePerson({super.key});

  @override
  State<AddNewResourcePerson> createState() => _AddNewResourcePersonState();
}

class _AddNewResourcePersonState extends State<AddNewResourcePerson> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildTextField(
                      ...
                      maxLines: 1,
                      validatorMsg: "Please enter resource person name",
                      screenWidth: screenWidth,
                      screenHeight: screenHeight,
                    ),                    
                     buildDropdownField(
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                content: Text("Resource Person submitted successfully!"),
                              ),
                            );
                          }
                        },
