...
class ViewTrainingMaterialManagementDetails extends StatefulWidget {
  const ViewTrainingMaterialManagementDetails({super.key});

  @override
  State<ViewTrainingMaterialManagementDetails> createState() => _ViewTrainingMaterialManagementDetailsState();
}

class _ViewTrainingMaterialManagementDetailsState extends State<ViewTrainingMaterialManagementDetails> {
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                             Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TrainingMaterialManagementPage(
