...
class ViewTrainingCourseDetails extends StatefulWidget {
  const ViewTrainingCourseDetails({super.key});

  @override
  State<ViewTrainingCourseDetails> createState() => _ViewTrainingCourseDetailsState();
}

class _ViewTrainingCourseDetailsState extends State<ViewTrainingCourseDetails> {
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                             Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TrainingCourseManagementPage(
