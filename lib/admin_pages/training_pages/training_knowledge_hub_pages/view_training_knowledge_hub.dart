...
class ViewTrainingKnowledgeHubDetails extends StatefulWidget {
  const ViewTrainingKnowledgeHubDetails({super.key});

  @override
  State<ViewTrainingKnowledgeHubDetails> createState() => _ViewTrainingKnowledgeHubDetailsState();
}

class _ViewTrainingKnowledgeHubDetailsState extends State<ViewTrainingKnowledgeHubDetails> {
                        ...
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                             Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TrainingKnowledgeHubPage(
