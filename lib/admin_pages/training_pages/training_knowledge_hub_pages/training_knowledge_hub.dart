...
import 'package:citizen_care_system/admin_pages/training_pages/training_knowledge_hub_pages/view_training_knowledge_hub.dart';
...
class TrainingKnowledgeHubPage extends StatefulWidget {
  final List<String>? selectedLocations;
  final List<String>? selectedServiceType;
  final DateTime? startDate;
  final DateTime? endDate;

  const TrainingKnowledgeHubPage({
    super.key,
  ...
  @override
  State<TrainingKnowledgeHubPage> createState() => _TrainingKnowledgeHubPageState();
}

class _TrainingKnowledgeHubPageState extends State<TrainingKnowledgeHubPage> {
        ...
        menuItems: [
          HoverTapButton(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const ViewTrainingKnowledgeHubDetails()),
              );
            },
          ),
          HoverTapButton(
