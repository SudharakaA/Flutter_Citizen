...
class AddTrainingRequest extends StatefulWidget {
  const AddTrainingRequest({super.key});

  @override
  State<AddTrainingRequest> createState() => _AddTrainingRequestState();
}

class _AddTrainingRequestState extends State<AddTrainingRequest> {
  ...
  final List<String> _course = [
    ...
    'Government Accounts Procedure',
    'Financial management',
    'Audit training',
    'Procurement process',
    'Training on Pension and Employee Provident Fund, Employee Provident Fund',
    'Processing of salary conversions.'
  ];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    buildDropdownField(
                      ...
                      validatorMsg: "Please select a training course",
                      screenWidth: screenWidth,
                      screenHeight: screenHeight,
                    ),
                    buildTextField(
                    ...
                    buildTextField(
                      ...
                      validatorMsg: "Please enter current salary",
                      screenWidth: screenWidth,
                      screenHeight: screenHeight,
                    ),
                    //SizedBox(height: screenHeight * 0.03),
                    buildTextField(
                      label: "Highest Education Qualifiaction",
                      controller :TextEditingController(),
                      maxLines: 3,
                      validatorMsg: "Please enter a qualification",
                      screenWidth: screenWidth,
                      screenHeight: screenHeight,
                    ),
                    //SizedBox(height: screenHeight * 0.03),
