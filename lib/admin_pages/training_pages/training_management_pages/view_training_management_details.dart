...
class ViewTrainingManagementDetails extends StatefulWidget {
  const ViewTrainingManagementDetails({super.key});

  @override
  State<ViewTrainingManagementDetails> createState() => _ViewTrainingManagementDetailsState();
}

class _ViewTrainingManagementDetailsState extends State<ViewTrainingManagementDetails> {
